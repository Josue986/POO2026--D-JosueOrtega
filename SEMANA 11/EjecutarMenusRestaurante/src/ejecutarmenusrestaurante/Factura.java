...
public class Factura {
    ...
    private double iva; // Porcentaje de IVA (ej: 0.15 para el 15%)
    private double total;
    private List<DetallesFactura> detalles; // Listado de detalles pedidos por el cliente
    ...
    public String toString() {
        calcularTotal(); // Asegura el cálculo antes de imprimir
